...
<body>
    ...
    <div class="w-1/2 mx-auto mb-12">
        <h2 class="text-blue-500 text-xl font-bold">連続学習日数</h2>
        ...
        <h2 class="text-blue-500 text-xl font-bold mt-4">今週の目標</h2>
        ...
        <h2 class="text-blue-500 text-xl font-bold mt-4">最近の学習記録</h2>
    ...
    <a class="w-48 mx-auto bg-blue-400 py-4 px-4 rounded-full text-xl text-white text-center block"
